...
// var li = header.querySelectorAll(".li");
// console.log( window.location.href);
// for (var i = 0; i < li.length; i++) {
//   li[i].childNodes[0].addEventListener("load", function() {     
//     var current = document.getElementsByClassName("active-nav-menu");
//     current[0].className = current[0].className.replace(" active-nav-menu", "");
//     this.className += " active-nav-menu";
//   });
// }
